  ...
  return (
    <div>
      ...
      <div className="flex-col text-center items-center justify-center">
        <h1 className="font-extrabold md:text-4xl text-2xl md:pl-24 md:pr-24 pl-10 pr-10 text-center mt-24">
          Leverage The Expertise of Available Python Developers
        </h1>
        <h1 className="text-xl font-medium text-gray-600 text-center m-8  md:pl-32 md:pr-32 leading-7 ">
          Our Python developers utilise best-in-class tools, state-of-the-art
          technologies and updated approaches to uplift your business.
        </h1>
      </div>
    </div>
  );
